  ...
  const allEvents: { text: string; options: MatchOption[] }[] = [
    {
      ...
      options: [
        { text: '⭐️⭐️⭐️⭐️ Радуга и обводка', stars: 4, skill: 'dribbling', difficulty: 70, successXp: 8, skillGrowth: 1, resultText: 'Невероятно! Радуга прошла! Ты на рандеву с вратарём!', failText: 'Не получилось... Мяч улетел в аут.' },
        { text: '⭐️⭐️ Навес в штрафную', stars: 2, skill: 'passing', difficulty: 40, successXp: 4, skillGrowth: 0, resultText: 'Отличный навес! Партнёр бьёт!', failText: 'Навес ушёл далеко от партнёра.' },
        { text: '⭐️⭐️⭐️ Пробить издали', stars: 3, skill: 'shooting', difficulty: 60, successXp: 6, skillGrowth: 1, resultText: 'Удар в дальнюю девятку! ГОЛ!!!', failText: 'Удар прошёл мимо ворот.' },
      ],
    },
    {
      text: 'Тебе отдают мяч в центре поля, ты видишь открывшегося партнёра.',
      options: [
        { text: '⭐️ Короткий пас', stars: 1, skill: 'passing', difficulty: 25, successXp: 3, skillGrowth: 0, resultText: 'Хороший простой пас. Игра продолжается.', failText: 'Пас неточный. Соперник перехватил.' },
        { text: '⭐️⭐️⭐️ Дриблинг через центр', stars: 3, skill: 'dribbling', difficulty: 55, successXp: 6, skillGrowth: 1, resultText: 'Ты прошёл двух защитников и вышел на ударную!', failText: 'Защитник прочитал. Мяч потерян.' },
        { text: '⭐️⭐️ Длинный перевод', stars: 2, skill: 'passing', difficulty: 45, successXp: 4, skillGrowth: 0, resultText: 'Отличный перевод фланга! Команда в атаке!', failText: 'Перевод перехвачен.' },
      ],
    },
    {
      text: 'Соперник проводит контратаку! Как действуешь?',
      options: [
        { text: '⭐️⭐️ Вступить в отбор', stars: 2, skill: 'defending', difficulty: 40, successXp: 4, skillGrowth: 0, resultText: 'Отличный отбор! Мяч у тебя.', failText: 'Промазал. Соперник выходит один на один...' },
        { text: '⭐️⭐️⭐️ Сыграть на опережение', stars: 3, skill: 'pace', difficulty: 55, successXp: 6, skillGrowth: 1, resultText: 'Ты успел первым! Какая реакция!', failText: 'Не успел. Соперник бьёт...' },
        { text: '⭐️ Вернуться в позицию', stars: 1, skill: 'physical', difficulty: 25, successXp: 3, skillGrowth: 0, resultText: 'Правильно занял позицию, атака захлебнулась.', failText: 'Не успел вернуться.' },
      ],
    },
    {
      text: 'Мяч на подступах к штрафной соперника. Твои действия?',
      options: [
        { text: '⭐️⭐️⭐️⭐️ Удар через себя!', stars: 4, skill: 'shooting', difficulty: 75, successXp: 8, skillGrowth: 1, resultText: 'НЕВЕРОЯТНО! Удар через себя — В ДЕВЯТКУ!', failText: 'Попытка не удалась. Мяч над перекладиной.' },
        { text: '⭐️⭐️ Разрезающая передача', stars: 2, skill: 'passing', difficulty: 40, successXp: 4, skillGrowth: 0, resultText: 'Гениальный пас! Партнёр бьёт!', failText: 'Передача перехвачена.' },
        { text: '⭐️⭐️⭐️ Обвести и пробить', stars: 3, skill: 'dribbling', difficulty: 55, successXp: 6, skillGrowth: 1, resultText: 'Обвёл одного, второго... Удар! ГОЛ!', failText: 'Обводка не удалась.' },
      ],
    },
    {
      text: 'Стандартное положение — штрафной в опасной зоне.',
      options: [
        { text: '⭐️⭐️ Удар в створ', stars: 2, skill: 'shooting', difficulty: 45, successXp: 4, skillGrowth: 0, resultText: 'Хороший удар! Вратарь на угловой.', failText: 'Удар в стенку.' },
        { text: '⭐️ Навес на ближнюю', stars: 1, skill: 'passing', difficulty: 30, successXp: 3, skillGrowth: 0, resultText: 'Хороший навес! Партнёр бьёт головой!', failText: 'Навес слабый. Вратарь забрал.' },
        { text: '⭐️⭐️⭐️ Розыгрыш', stars: 3, skill: 'passing', difficulty: 55, successXp: 6, skillGrowth: 1, resultText: 'Гениальный розыгрыш! Один на один — ГОЛ!', failText: 'Розыгрыш не удался.' },
      ],
    },
    {
      text: 'Ты получаешь мяч в своей штрафной. Соперник давит!',
      options: [
        { text: '⭐️ Выбить подальше', stars: 1, skill: 'physical', difficulty: 25, successXp: 3, skillGrowth: 0, resultText: 'Мяч далеко. Опасность миновала.', failText: 'Неточный вынос. Соперник снова давит.' },
        { text: '⭐️⭐️ Начать атаку пасом', stars: 2, skill: 'passing', difficulty: 40, successXp: 4, skillGrowth: 0, resultText: 'Точный пас. Атака начинается!', failText: 'Пас перехвачен у своих ворот.' },
        { text: '⭐️⭐️⭐️ Выход с мячом', stars: 3, skill: 'dribbling', difficulty: 60, successXp: 6, skillGrowth: 1, resultText: 'Обвёл нападающего и начал атаку!', failText: 'Потерял мяч в штрафной!' },
      ],
    },
    {
      text: 'Последние минуты матча. Счёт равный. Ты с мячом.',
      options: [
        { text: '⭐️⭐️⭐️ Взять игру на себя!', stars: 3, skill: 'shooting', difficulty: 60, successXp: 6, skillGrowth: 1, resultText: 'Ты рвёшь оборону и забиваешь победный!!!', failText: 'Удар заблокирован. Ничья.' },
        { text: '⭐️⭐️ Пас под удар', stars: 2, skill: 'passing', difficulty: 40, successXp: 4, skillGrowth: 0, resultText: 'Отдал на свободного — ГОЛ! Победа!', failText: 'Передача неточная. Момент потерян.' },
        { text: '⭐️ Сохранить мяч', stars: 1, skill: 'physical', difficulty: 25, successXp: 3, skillGrowth: 0, resultText: 'Мудрое решение. Время уходит.', failText: 'Мяч потерян. Соперник давит.' },
      ],
    },
  ];
...
// ==================== LOCAL STORAGE ====================
const SAVE_KEY = 'fc_save_v4_balanced';
...
export default function App() {
  ...
  const makeChoice = (optIdx: number) => {
    ...
    if (success && opt.skillGrowth > 0 && Math.random() < 0.3) {
      newSkills[opt.skill] = Math.min(99, newSkills[opt.skill] + opt.skillGrowth);
    }
  ...
  const applyTraining = () => {
    ...
    setPlayer({ ...player, skills: newSkills, xp: player.xp + 20, trainingCount: player.trainingCount + 1 });
    setMatchesUntilTraining(MATCHES_BETWEEN_TRAINING);
    notify('✅ Тренировка завершена! +к навыкам, +20 XP');
    setScreen('dashboard');
  };
  ...
  const upgradeSkill = (skill: keyof Skills) => {
    if (!player || player.xp < 15 || player.skills[skill] >= 99) return;
    const ns = { ...player.skills };
    ns[skill]++;
    setPlayer({ ...player, skills: ns, xp: player.xp - 15 });
    notify(`⬆️ Навык повышен! (-15 XP)`);
  };
              ...
              {(Object.keys(player.skills) as (keyof Skills)[]).map(skill => (
                <div key={skill} className="flex items-center gap-2">
                  ...
                  {player.xp >= 5 && player.skills[skill] < 99 && (
                    <button onClick={() => upgradeSkill(skill)} className="text-yellow-400 text-xs hover:text-yellow-300 px-1 transition shrink-0" title="Прокачать за 15 XP">⬆️</button>
                  )}
                </div>
              ))}
            </div>
